/*  Test_Homing_Motor1_Switch.ino
    ...
    and a mechanical switch with normaly open contacts.
  
    The Teensy 4.1 is looking for a HIGH to LOW signal transition
    on its internally pulled up input.
